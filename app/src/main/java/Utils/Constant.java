...
//    public static String POST_MY_TARGET = "http://dev.technology-minds.com/metro_dev/web_services/my_target.php?user_id=";
    ...
    public static String POST_LOGIN = "http://ferozproducts.com/order-system/web_services/login.php";
    public static String POST_REGISTER_STORE = "http://ferozproducts.com/order-system/web_services/register_store.php";
    public static String POST_MY_ACCOUNT = "http://ferozproducts.com/order-system/web_services/my_account.php";
    public static String POST_INSERT_GCM = "http://ferozproducts.com/order-system/web_services/insert_gcm.php";
    public static String POST_GET_ALL_CATEGORY = "http://ferozproducts.com/order-system/web_services/get_all_category.php";
    public static String POST_GET_ALL_ZONE = "http://ferozproducts.com/order-system/web_services/get_all_zone.php";
    public static String POST_GET_ALL_NOTIFICATION = "http://ferozproducts.com/order-system/web_services/get_all_notification.php";
    public static String POST_GET_ALL_USER_NOTIFICATION = "http://ferozproducts.com/order-system/web_services/get_all_user_notification.php";
    public static String POST_GET_ALL_PRODUCT_WITH_FLAVOUR = "http://ferozproducts.com/order-system/web_services/get_all_products.php";
    public static String POST_GET_ALL_STORES = "http://ferozproducts.com/order-system/web_services/get_all_stores.php";
    public static String POST_GET_LATEST_STORES = "http://ferozproducts.com/order-system/web_services/get_latest_stores.php";
    public static String POST_GET_ALL_INSTRUCTIONS = "http://ferozproducts.com/order-system/web_services/get_all_instructions.php";
    public static String POST_PLACE_ORDERS = "http://ferozproducts.com/order-system/web_services/place_order.php";
    //public static String POST_GET_ALL_PAST_ORDERS = "http://ferozproducts.com/order-system/web_services/get_all_past_order.php";
    public static String POST_GET_ALL_PAST_ORDER_DETAILS = "http://ferozproducts.com/order-system/web_services/get_all_past_order_detail.php";
    public static String POST_GET_ALL_ORDERS = "http://ferozproducts.com/order-system/web_services/get_all_orders.php";
    public static String POST_UPDATE_LOCATION = "http://ferozproducts.com/order-system/web_services/update_location.php";
    public static String POST_MY_TARGET = "http://ferozproducts.com/order-system/web_services/my_target.php?user_id=";
